...
export default function DashboardClient({
  ...
  const totalViewed = quotes.filter(
    (q) => q.status === "viewed" || q.status === "applied",
  ).length;
              ...
              >
                ...
                <span
                  style={{
                    padding: "3px 10px",
                    borderRadius: "100px",
                    background: statusBg[q.status] || statusBg.sent,
                    fontSize: "11px",
                    color: statusColor[q.status] || statusColor.sent,
                    fontWeight: 700,
                  }}
                >
